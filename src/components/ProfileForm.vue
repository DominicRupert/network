<template>
  <form class="d-flex flex-column row" action="" @submit="saveAccount">
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-8">
          ...
          <input class="form-control" type="text" v-model="editable.linkedin" />
          <label for="">github</label>
          <input class="form-control" type="text" v-model="editable.github" />
          <label for="">account picture</label>
          <input type="text" class="form-control" v-model="editable.picture" />

          <div>
            <button class="btn btn-primary p-3 mt-2">Edit Profile</button>
          </div>
        </div>
      </div>
    </div>
